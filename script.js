...
function SettingsAlert(){
    this.render = function(){
        ...
        settingsModalPopup.setAttribute("class", "w-2/4 h-auto overflow-hidden bg-gray-900 text-indigo-300 shadow-lg rounded-lg absolute top-2/4 left-2/4 transform -translate-x-2/4 -translate-y-2/4 z-50 p-10px text-center visible");
    ...
    this.ok = function(){
        document.getElementById("settings-modal-popup").setAttribute("class", "w-2/4 h-auto overflow-hidden bg-white shadow-lg rounded-lg absolute top-2/4 left-2/4 transform -translate-x-2/4 -translate-y-2/4 z-50 p-10px text-center invisible");
